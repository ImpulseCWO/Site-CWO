    ...
    <main className="min-h-screen bg-white">
      <section className="bg-gradient-to-r from-impulse-dark to-impulse-light text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold">Auditórios</h1>
          <p className="text-lg text-white/90 mt-4 max-w-3xl">
            Auditórios equipados para palestras, treinamentos e eventos corporativos. Capacidade de 20 a 120 pessoas, som, projeção e suporte técnico. 
          </p>
          <div className="mt-6">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <h2 className="text-2xl font-semibold text-impulse-dark">Indicada para</h2>
            ...
            <h2 className="text-2xl font-semibold text-impulse-dark">Implantação</h2>
          ...
          <aside className="bg-gray-50 rounded-2xl p-6 h-fit shadow">
            <h3 className="text-lg font-semibold text-impulse-dark">Fale com especialista</h3>
            ...
            <a
              ...
              className="mt-4 inline-block bg-impulse-light text-white font-semibold px-6 py-3 rounded-full"
            >
              Falar no WhatsApp
            </a>
          </aside>
