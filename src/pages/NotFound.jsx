...
export default function NotFound() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-impulse-dark via-impulse-dark to-impulse-light flex items-center">
      <div className="w-full">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/"
              className="inline-block bg-white text-impulse-dark hover:bg-gray-100 font-semibold px-6 py-3 rounded-full transition"
            >
            ...
            <a
              ...
              className="inline-block bg-impulse-light hover:bg-blue-400 text-white font-semibold px-6 py-3 rounded-full transition"
            >
              Falar no WhatsApp
            </a>
          </div>
